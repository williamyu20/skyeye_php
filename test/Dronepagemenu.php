...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a href="CreateDrone.php" class="nav-link">Create Drone</a>
        </li>
        <li class="nav-item">
            <a href="updateDrone.php" class="nav-link">Update Drone</a>
        </li>
        <li class="nav-item">
            <a href="deleteDrone.php" class="nav-link">Delete Drone</a>
        </li>
    </ul>
</div>
